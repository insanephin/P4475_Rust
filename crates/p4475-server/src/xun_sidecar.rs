...
use p4475_profile::{CatalogInventory, CatalogXunProfile};
use thiserror::Error;
use tokio::{
...
mod tests {
    ...
    use p4475_profile::CatalogXunProfile;
    use tokio::{
        io::{AsyncReadExt, AsyncWriteExt},
    ...
    async fn nickname_channel_delivers_profiles_and_accepts_reserved_client_frames() {
        ...
        reserved[4..6].copy_from_slice(
            &p4475_core::xun_sidecar_protocol::XUN_SIDECAR_PROTOCOL_VERSION.to_le_bytes(),
        );
